    ...
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-20">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8">
        <h1 className="text-4xl font-bold  text-center">
          About <span className="text-red-500 font-serif">Electro</span>
          nica
        </h1>

        <p className="text-gray-700 text-lg">
          Welcome to{" "}
          <span className="font-semibold text-red-600">Electronica</span>, your
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-700 text-base">
            At Electronica, our mission is to make innovative technology
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-700 text-base">
            ...
            Electronica, we’re committed to staying ahead of the curve, offering
        ...
        <div className="text-center mt-10">
          <h3 className="text-xl font-semibold text-red-600 mb-2">
            Join the Electronica Family
          </h3>
          <p className="text-gray-700 mb-4">
            Whether you’re a tech enthusiast, a professional, or just looking
            for something cool and functional — Electronica has something for
            everyone.
          </p>
          <Link to={"/products"}>
